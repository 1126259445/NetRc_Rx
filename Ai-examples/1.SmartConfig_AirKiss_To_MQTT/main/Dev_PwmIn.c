...
//        if(abs(Rc.RC_ch[0] - current_ch_val) > PWMIN_FIFTER)
        {
...
static void gpio_1_isr_handler(void *arg)
{
 ...
 //       if(abs(Rc.RC_ch[1] - current_ch_val) > PWMIN_FIFTER)
        {
...
static void gpio_2_isr_handler(void *arg)
{
 ...
 //       if(abs(Rc.RC_ch[2] - current_ch_val) > PWMIN_FIFTER)
        {
...
//        if(abs(Rc.RC_ch[3] - current_ch_val) > PWMIN_FIFTER)
        {
...
//        if(abs(Rc.RC_ch[4] - current_ch_val) > PWMIN_FIFTER)
        {
